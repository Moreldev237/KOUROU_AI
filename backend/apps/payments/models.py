...
class ReferralReward(models.Model):
    """Journalise la récompense attribuée au parrain quand un filleul souscrit."""

    referrer = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="referral_rewards")
    referred_user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="referral_reward_events")
    subscription = models.OneToOneField(Subscription, on_delete=models.CASCADE, related_name="referral_reward")
    ...
    def __str__(self):
        return f"{self.referrer} reçoit {self.amount} pour {self.referred_user}"
