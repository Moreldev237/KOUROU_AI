...
from .services import document_extractor, generation_service, gemini_client, prompt_templates
...
class TutorChatView(APIView):
    ...
    def post(self, request):
        ...
        consume_quota(request.user, exam=d.get("exam"))  # le tuteur consomme aussi le quota gratuit journalier
        ...
        documents = document_extractor.extract_documents(d.get("documents") or [])
        documents = document_extractor.select_relevant_documents(documents, d["message"])
