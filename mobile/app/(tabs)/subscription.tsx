  ...
  return (
    ...
    >
      ...
      <Text style={styles.helperText}>
        Choisissez un forfait pour vous entraîner sans limite ou continuez avec votre compte gratuit.
      </Text>
...
const styles = StyleSheet.create({
  ...
  planHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: spacing.xs, marginBottom: spacing.xs },
  planName: { ...typography.h3, color: colors.textPrimary, flex: 1, flexShrink: 1, minWidth: 150 },
  planPrice: { ...typography.h3, color: colors.primary, flexShrink: 1, textAlign: "right" },
